...
// Retained as part of the browser-facing history-data contract.
...
const SOURCE_STATUS_NOTICE = Object.freeze({
  ja: Object.freeze({
    title: "お知らせ",
    message:
      "お使いいただきありがとうございます。皆さまのご利用が励みになっております。\n\nただ今、情報源としているPvPトラッカーサイトにて画面の表示エラーが発生しておりますが、情報源サイト側の編成データ自体は正常に機能しております。\n\nそのため当サイトでのデータ取得・集計（キャラ数情報など）も問題ございませんが、一部の画像のみ暫定表示となっております。\n\nデータ元の正規画像が更新され次第、正常な画像へ自動的に切り替わります。\nご安心の上、ご利用頂けますと幸いです。",
  }),
  en: Object.freeze({
    title: "Notice",
    message:
